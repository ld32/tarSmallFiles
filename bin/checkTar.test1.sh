...
export sFolder=/n/htem/.snapshot/o2_groups_htem_daily_2024-09-10_23-45/temcagt/datasets/gut1
export dFolder=/n/data3_vast/groups_datasets/ld32/gut1
export logDir=/n/data3_vast/groups_datasets/ld32/gut1Log

#cat  /n/data3_vast/groups_datasets/ld32/gut1Log/folders.txt  | while IFS= read -r line; do
  archiveFiles /n/htem/.snapshot/o2_groups_htem_daily_2024-09-03_23-45/temcagt/datasets/gut1/171222051908_gut_0045/intrasection/amaps $jIndex
