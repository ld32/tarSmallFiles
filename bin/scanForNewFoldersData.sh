...
while IFS= read -r rFolder; do
    ...
    while IFS= read -r dFolder; do
        ...
        #/n/data3/.snapshot/o2_data3_daily_2024-10-07_00-00/hms/neurobio/htem/temcagt/datasets/dorsalhorn_th/intersection
        dFolder="/n/data3/hms/neurobio/htem/temcagt/${dFolder#*temcagt/}" # for group
        if [ -d "$dFolder" ]; then 
